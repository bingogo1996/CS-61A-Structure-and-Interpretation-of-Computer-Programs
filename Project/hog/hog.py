...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def high(score0,score1):
        if who==0:
            ...
            return announce_highest(who,score0,score0-last_score if score0-last_score>running_high else running_high)
        else:
            if score1-last_score>running_high:
                print(score1-last_score,"point(s)! That's a record gain for Player 1!")
            return announce_highest(who,score1,score1-last_score if score1-last_score>running_high else running_high)
    return high
    # END PROBLEM 7
